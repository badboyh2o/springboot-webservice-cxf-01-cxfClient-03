 ...
 * 
 */
@WebServiceClient(name = "CommonService", targetNamespace = "http://webservice.badboyh2o.com/", wsdlLocation = "http://localhost:8080/services/CommonService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName COMMONSERVICE_QNAME = new QName("http://webservice.badboyh2o.com/", "CommonService");
     ...
     */
    @WebEndpoint(name = "CommonServiceImpPort")
    public CommonService getCommonServiceImpPort() {
        return super.getPort(new QName("http://webservice.badboyh2o.com/", "CommonServiceImpPort"), CommonService.class);
    }
     ...
     */
    @WebEndpoint(name = "CommonServiceImpPort")
    public CommonService getCommonServiceImpPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webservice.badboyh2o.com/", "CommonServiceImpPort"), CommonService.class, features);
    }
